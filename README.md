...
- 🎨 Framer Motion & GSAP for sleek animations
- 🌀 Custom shader-based components (`GradientBlinds`, `LiquidEther`)
...
- 🎬 **Netflix-inspired Interface** – Interactive profile selector with 3D lighting & smooth transitions.  
- 💻 **Dynamic Pages**:
